...
const XboxCalculator = () => {
  ...
  // Xbox Rewards points exchange rates (based on Microsoft Store pricing)
  const exchangeRates = {
    USD: 0.009, // 1 point = $0.009 (US region)
    EUR: 0.008, // 1 point = €0.008 (EU region)
    GBP: 0.007, // 1 point = £0.007 (UK region)
    CAD: 0.012, // 1 point = C$0.012 (Canada)
    AUD: 0.013, // 1 point = A$0.013 (Australia)
  }
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        <div className="mb-4">
          ...
          >
            ← Back to Gaming Points
          </Link>
        </div>
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Xbox Rewards Calculator
        </h1>
        <p className="text-xl text-gray-600">
          Calculate your Xbox Rewards points redemption value
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter Xbox Rewards points amount"
          ...
          {result !== null ? (
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {points} Xbox Rewards points = {formatCurrency(result, currency)}
              </p>
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  💡 Tip: Xbox Rewards points can be redeemed for Microsoft Store credit, games, and Xbox Live Gold.
                </p>
              </div>
            </div>
          ) : (
