...
const LufthansaCalculator = () => {
  ...
  // Lufthansa miles exchange rates (based on typical redemption values)
  const exchangeRates = {
    USD: 0.014, // 1 mile = $0.014 (US region)
    EUR: 0.013, // 1 mile = €0.013 (EU region)
    GBP: 0.011, // 1 mile = £0.011 (UK region)
    CAD: 0.019, // 1 mile = C$0.019 (Canada)
    AUD: 0.021, // 1 mile = A$0.021 (Australia)
  }
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">
          Calculate your Lufthansa miles redemption value
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter Lufthansa miles amount"
          ...
          {result !== null ? (
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {miles} Lufthansa miles = {formatCurrency(result, currency)}
              </p>
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  💡 Tip: Lufthansa miles (Miles & More) can be redeemed for flights, upgrades, and partner rewards. Value may vary based on route and booking class.
                </p>
              </div>
            </div>
          ) : (
...
export default LufthansaCalculator
