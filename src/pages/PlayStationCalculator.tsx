...
const PlayStationCalculator = () => {
  ...
  // PlayStation Stars points exchange rates (based on PSN store pricing)
  const exchangeRates = {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          PlayStation Stars Calculator
        </h1>
        <p className="text-xl text-gray-600">
          Calculate your PlayStation Stars points redemption value
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter PlayStation Stars points amount"
          ...
          {result !== null ? (
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {points} PlayStation Stars points = {formatCurrency(result, currency)}
              </p>
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  💡 Tip: PlayStation Stars points can be redeemed for PSN wallet funds, games, and exclusive rewards.
                </p>
              </div>
            </div>
          ) : (
...
export default PlayStationCalculator
