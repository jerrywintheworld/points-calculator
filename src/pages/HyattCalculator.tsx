...
const HyattCalculator = () => {
  ...
  // World of Hyatt points exchange rates (based on typical redemption values)
  const exchangeRates = {
    USD: 0.017, // 1 point = $0.017 (US region)
    EUR: 0.016, // 1 point = €0.016 (EU region)
    GBP: 0.014, // 1 point = £0.014 (UK region)
    CAD: 0.023, // 1 point = C$0.023 (Canada)
    AUD: 0.026, // 1 point = A$0.026 (Australia)
  }
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">
          Calculate your World of Hyatt points redemption value
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter World of Hyatt points amount"
          ...
          {result !== null ? (
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {points} World of Hyatt points = {formatCurrency(result, currency)}
              </p>
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  💡 Tip: World of Hyatt points can be redeemed for hotel stays, flights, and exclusive experiences. Value may vary based on property and booking dates.
                </p>
              </div>
            </div>
          ) : (
...
export default HyattCalculator
