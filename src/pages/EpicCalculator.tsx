...
const EpicCalculator = () => {
  ...
  // Epic Games points exchange rates (based on Epic Store pricing)
  const exchangeRates = {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Epic Games Points Calculator
        </h1>
        <p className="text-xl text-gray-600">
          Calculate your Epic Games points redemption value
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter Epic Games points amount"
          ...
          {result !== null ? (
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {points} Epic Games points = {formatCurrency(result, currency)}
              </p>
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  💡 Tip: Epic Games points can be redeemed for games, DLC, and exclusive content on the Epic Games Store.
                </p>
              </div>
            </div>
          ) : (
