...
const IHGCalculator = () => {
  ...
  // IHG Rewards points exchange rates (based on typical redemption values)
  const exchangeRates = {
    USD: 0.005, // 1 point = $0.005 (US region)
    EUR: 0.004, // 1 point = €0.004 (EU region)
    GBP: 0.003, // 1 point = £0.003 (UK region)
    CAD: 0.007, // 1 point = C$0.007 (Canada)
    AUD: 0.008, // 1 point = A$0.008 (Australia)
  }
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          IHG Rewards Points Calculator
        </h1>
        <p className="text-xl text-gray-600">
          Calculate your IHG Rewards points redemption value
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter IHG Rewards points amount"
          ...
          {result !== null ? (
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {points} IHG Rewards points = {formatCurrency(result, currency)}
              </p>
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  💡 Tip: IHG Rewards points can be redeemed for hotel stays, flights, and exclusive experiences. Value may vary based on property and booking dates.
                </p>
              </div>
            </div>
          ) : (
