...
const HiltonCalculator = () => {
  ...
  // Hilton Honors points exchange rates (based on typical redemption values)
  const exchangeRates = {
    USD: 0.006, // 1 point = $0.006 (US region)
    EUR: 0.005, // 1 point = €0.005 (EU region)
    GBP: 0.004, // 1 point = £0.004 (UK region)
    CAD: 0.008, // 1 point = C$0.008 (Canada)
    AUD: 0.009, // 1 point = A$0.009 (Australia)
  }
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">
          Calculate your Hilton Honors points redemption value
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Enter Hilton Honors points amount"
          ...
          {result !== null ? (
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {points} Hilton Honors points = {formatCurrency(result, currency)}
              </p>
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  💡 Tip: Hilton Honors points can be redeemed for hotel stays, flights, and exclusive experiences. Value may vary based on property and booking dates.
                </p>
              </div>
            </div>
          ) : (
...
export default HiltonCalculator
